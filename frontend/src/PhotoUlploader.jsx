          ...
          addedPhotos.map((link) => (
            <div className="h-32 flex relative" key={link}>
              ...
              <button
                ...
                className="cursor-pointer absolute bottom-1 right-1 text-white bg-opacity-50 bg-black p-1 rounded-2xl py-2 px-3"
              >
                <svg
              ...
              <button
                ...
                className="cursor-pointer absolute bottom-1 left-1 text-white bg-opacity-50 bg-black p-1 rounded-2xl py-2 px-3"
              >
                {link === addedPhotos[0] && (
                  <svg
                  xmlns="http://www.w3.org/2000/svg"
...
export default PhotosUlploader;
